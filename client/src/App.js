 ...
 * coingecko API often, so to prevent throttling/redundant API calls, the data is saved in local storage often (even 
 * though this may make the data out of date).
 *
 * Author: Ryan Freas
 * Created: 12/01/23
 *
